<div class="inline-block">
  @if ($memmo->is_shared)
  <a class="font-mono text-xs ms-2 text-paper-600 hover:text-paper-800"
  ...
  <button type="button" class="ms-3 text-gray-500 hover:text-gray-700"
    wire:confirm="you sure this memmo go private?"
    wire:click="unshare">unshare</button>
  @else
  <button type="button" class="ms-3 text-binder-600 hover:text-binder-800"
